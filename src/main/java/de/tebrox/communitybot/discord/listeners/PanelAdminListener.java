...
public class PanelAdminListener extends ListenerAdapter {
    ...
    public PanelAdminListener(GuildConfigManager configManager, PanelService panelService, LogBuffer logBuffer) {
    ...
    private void postNewPanel(SlashCommandInteractionEvent event, Guild guild, GuildConfig cfg,
    ...
    private TextChannel resolveTargetChannel(Guild guild, GuildConfig cfg, SlashCommandInteractionEvent event) {
    ...
    public void refreshPanel(Guild guild, GuildConfig cfg) {
        String guildId = guild.getId();
        Optional<PanelState> stateOpt = panelService.findState(guildId);
